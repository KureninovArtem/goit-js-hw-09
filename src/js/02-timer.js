...
function convertMs(ms) {
    ...
    minutesElement.textContent = minutes < 10 ? addLeadingZero(String(minutes)) : minutes;
    secondsElement.textContent = seconds < 10 ? addLeadingZero(String(seconds)) : seconds;
}
